...
export default function customer() {
  ...
  const arr3 = [
    {
      title: '',
      text: 'We compile pain stories based on qualitative research results and present case studies where customers lost their money or got stuck with the development. Case studies are presented below in an intuitive way and can be easily grasped by the general audiences',
      iconCheck: true,
    },
    {
      title: '',
                ...
                <div className="ph-20">
                  <div className="count-block w-100 mb-40">
                    ...
                    <p className="text-large mb-40">
                      To identify customer pains and eliminate barriers for boosting your revenue and achieving your
                      business goals
                    </p>
                  </div>
                  <div className="count-block w-100 mb-40">
            ...
            <div className="row">
              <div className="col-12 col-xl-8 m-auto">
                <p className="section__text ta-left ta-md-center">
                  Misidentifying your customers’ pains or their priorities to perform JBTD results in your team working
                  for weeks/months on problems that your customers aren’t willing to pay for, which is $xxx.xx spent in
                  vain.
                </p>
              </div>
            </div>
                ...
                <div className="ph-20">
                  <div className="count-block w-100 mb-40">
                    ...
                    <div className="text-large mb-20">
                      ...
                      <p className='mb-10'> Is it feasible and profitable?
                      </p>
                      <p className='mb-10'> What is the budget estimate to create MVP and launch sales?
                      </p>
                      <p className='mb-10'> Does it have scaling potential for other markets?
                      </p>
                      <p> How to estimate your product value and attract first investors?
                      </p>
                    </div>
                  </div>
                  <div className="count-block w-100 mb-40">
                    ...
                    <div className="text-large mb-20">
                      ...
                      <p className='mb-10'> How to boost revenue for existing products/services?
                      </p>
                      <p className='mb-10'> What is the budget estimate to create MVP and launch sales?
                      </p>
                      <p className='mb-10'> How to reduce CAC? (Customer Acquisition Cost)
                      </p>
                      <p className='mb-10'> What core features are required for a successful release?
                      </p>
                      <p className='mb-10'> How to reach stable ROI?
                      </p>
                      <p> What is the optimal development strategy for the X market?
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="count-block w-100 mb-40">
                    ...
                    <div className="text-large mb-20">
                      ...
                      <p className='mb-10'>How to minimize the risks of ineffective spending and avoid negative ROI?
                      </p>
                      <p className='mb-10'>How to build communication with the client?
                      </p>
                      <p className='mb-10'>What are the features your users need right now?
                      </p>
                      <p className='mb-10'>How can we increase sales/reduce CAC?
                      </p>
        ...
        <section className="section section--title-right-img10 mb-60 mb-md-0">
          <div className="container p-0">
            <div className="row">
              ...
              <div className="col-12 col-md-6 col-xl-4 offset-xl-1 pt-md-50  pb-md-50 pt-xl-100 pb-xl-100">
                <div className='ph-20'><span className="line mb-30"></span></div>
