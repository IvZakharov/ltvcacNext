              ...
              <div className="ph-20">
                <ul className="list">
                  <li className="text-large mb-20">
                    Get stable and scalable user acquisition channels
                  </li>
                  <li className="text-large mb-20">
                    Get high conversion in app installs or sales on website and a favorable price
                    per user
                  </li>
                  <li className="text-large mb-20">Facebook-Instagram +23%,</li>
                  <li className="text-large mb-20">
