            ...
            <section className={`pt-68 pb-68 ${style.benefitsAdaptive}`}>
                <div className="container">
                    <div className={`row ${style.mob}`}>
                        <div className={`${style.sectionText} mrw-120 p-0`}>
                    ...
                    <div className={`row ${style.Blocks} p-0`}>
                        ...
                        <div className={style.Block}>
                            <svg width="88" height="82" viewBox="0 0 88 82" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M23.6505 61.6169L29.1502 54.7533L11.4454 40.6089L29.1502 26.4644L23.6505 19.6009L1.6515 37.1771C1.13604 37.5888 0.719922 38.111 0.433957 38.705C0.147993 39.2991 -0.000488281 39.9498 -0.000488281 40.6089C-0.000488281 41.268 0.147993 41.9187 0.433957 42.5128C0.719922 43.1068 1.13604 43.629 1.6515 44.0406L23.6505 61.6169ZM64.3486 19.6009L58.8488 26.4644L76.5536 40.6089L58.8488 54.7533L64.3486 61.6169L86.3475 44.0406C86.863 43.629 87.2791 43.1068 87.5651 42.5128C87.851 41.9187 87.9995 41.268 87.9995 40.6089C87.9995 39.9498 87.851 39.2991 87.5651 38.705C87.2791 38.111 86.863 37.5888 86.3475 37.1771L64.3486 19.6009ZM57.0933 2.01151L39.4941 81.1045L30.9013 79.1975L48.5005 0.104492L57.0933 2.01151Z" fill="white"/>
                            </svg>
                    ...
                    <div className="row">
                        ...
                        <div className={`${style.panelAnim} p-0`}>
                            <div className={style.webpage}>
                                ...
                                <svg width="585" height="516" viewBox="0 0 585 516" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect x="2.28882e-05" width="585" height="368" rx="16.2263" fill="#D4D0EC"/>
                                    <path d="M2.28882e-05 16.2263C2.28882e-05 7.26477 7.26479 0 16.2263 0H130V368H16.2263C7.26479 368 2.28882e-05 360.735 2.28882e-05 351.774L2.28882e-05 16.2263Z" fill="#7E72C0"/>
                                    <path d="M8.11317 23.9339C8.11317 19.229 11.9272 15.415 16.632 15.415H108.311C113.015 15.415 116.829 19.229 116.829 23.9339C116.829 28.6387 113.015 32.4527 108.311 32.4527H16.632C11.9272 32.4527 8.11317 28.6387 8.11317 23.9339Z" fill="#F3F3F3"/>
                                    <path d="M8.11317 43.4055C8.11317 41.8373 9.38451 40.5659 10.9528 40.5659H113.99C115.558 40.5659 116.829 41.8373 116.829 43.4055C116.829 44.9738 115.558 46.2451 113.99 46.2451H10.9528C9.38451 46.2451 8.11317 44.9738 8.11317 43.4055Z" fill="#E3E3E3"/>
                                    <path d="M8.11317 57.1975C8.11317 55.6292 9.38451 54.3579 10.9528 54.3579H84.7825C86.3508 54.3579 87.6221 55.6292 87.6221 57.1975C87.6221 58.7658 86.3508 60.0371 84.7825 60.0371H10.9528C9.38451 60.0371 8.11317 58.7658 8.11317 57.1975Z" fill="#E3E3E3"/>
                                    <path d="M8.11317 70.99C8.11317 69.4217 9.38451 68.1504 10.9528 68.1504H103.443C105.011 68.1504 106.282 69.4217 106.282 70.99C106.282 72.5583 105.011 73.8296 103.443 73.8296H10.9528C9.38451 73.8296 8.11317 72.5583 8.11317 70.99Z" fill="#E3E3E3"/>
                                    <rect className={style.background} x="152" y="14.6035" width="411" height="501" rx="20" fill="white"/>
                                    <path d="M289.5 40.6035C289.5 37.2898 292.186 34.6035 295.5 34.6035H419.5C422.814 34.6035 425.5 37.2898 425.5 40.6035C425.5 43.9172 422.814 46.6035 419.5 46.6035H295.5C292.186 46.6035 289.5 43.9172 289.5 40.6035Z" fill="#7E72C0"/>
                                    <path d="M180 77.8298C180 68.8683 187.265 61.6035 196.226 61.6035H518.774C527.735 61.6035 535 68.8683 535 77.8298V157.377C535 166.339 527.735 173.604 518.774 173.604H196.226C187.265 173.604 180 166.339 180 157.377V77.8298Z" fill="#F3F3F3"/>
                                    <path d="M289.5 117.604C289.5 114.29 292.186 111.604 295.5 111.604H419.5C422.814 111.604 425.5 114.29 425.5 117.604C425.5 120.917 422.814 123.604 419.5 123.604H295.5C292.186 123.604 289.5 120.917 289.5 117.604Z" fill="#D0D0D0"/>
                                    <path d="M180.5 203.83C180.5 194.868 187.765 187.604 196.726 187.604H377.274C386.235 187.604 393.5 194.868 393.5 203.83V239.377C393.5 248.339 386.235 255.604 377.274 255.604H196.726C187.765 255.604 180.5 248.339 180.5 239.377V203.83Z" fill="#F3F3F3"/>
                                    <path d="M188.613 201.717C188.613 198.403 191.299 195.717 194.613 195.717H318.613C321.927 195.717 324.613 198.403 324.613 201.717C324.613 205.031 321.927 207.717 318.613 207.717H194.613C191.299 207.717 188.613 205.031 188.613 201.717Z" fill="#D0D0D0"/>
                                    <path d="M419.5 212.104C419.5 209.066 421.962 206.604 425 206.604H529C532.038 206.604 534.5 209.066 534.5 212.104C534.5 215.141 532.038 217.604 529 217.604H425C421.962 217.604 419.5 215.141 419.5 212.104Z" fill="#D0D0D0"/>
                                    ...
                                    <g clipPath="url(#clip0_513_121)" clipPathUnits="objectBoundingBox">
                                        <path d="M344.119 388.86C344.119 388.032 344.791 387.36 345.619 387.36H372.619C373.448 387.36 374.119 388.032 374.119 388.86C374.119 389.689 373.448 390.36 372.619 390.36H345.619C344.791 390.36 344.119 389.689 344.119 388.86Z" fill="#7E72C0"/>
                                        <path d="M356.998 375.149C357.827 375.149 358.498 375.821 358.498 376.649L358.498 403.649C358.498 404.478 357.827 405.149 356.998 405.149C356.17 405.149 355.498 404.478 355.498 403.649L355.498 376.649C355.498 375.821 356.17 375.149 356.998 375.149Z" fill="#7E72C0"/>
                                    </g>
                                    ...
                                    <defs>
                                        <clipPath id="clip0_513_121">
                                            <rect className={style.PlusBlock} x="344" y="374.993" width="27" height="27" rx="13.5" fill="white"/>
                                        </clipPath>
                                    </defs>
                                </svg>
                        ...
                        <div className={`${style.clouds} p-0`}>
                            <div className={style.cloud}>
                                ...
                                <div className={`${style.items} ${style.css}`}>
                                    <svg width="42" height="59" viewBox="0 0 32 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className={`${style.items} ${style.html}`}>
                                    <svg width="41" height="57" viewBox="0 0 32 45" fill="none" xmlns="http://www.w3.org/2000/svg">
