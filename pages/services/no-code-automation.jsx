...
export default function analytics() {
  ...
  const ourToolkitArr = [
    {
      ...
      text: 'Make (ex-Integromat), Zapier, Automate.io',
    },
    {
  ...
  return (
      <MainLayout
            ...
            <div className="row">
              ...
              <div
                ...
                <div className="ph-20">
                  ...
                  <p className="text mb-20">
                    It allows you to have your business processes run automatically just like an autopiloted plane.
                  </p>
                  <p className="text mb-20">
                    So instead of sending each and every customer a separate email about current promotions/supplies of
                    a new type of bread - you can press a couple of buttons to send it all at once.
                  </p>
            ...
            <div className="row">
              ...
              <div className="col-12 col-md-6 col-xl-4 offset-xl-1">
                <div className="ph-20 pt-md-50 pb-md-20 pt-xl-100 pb-xl-100">
                  <p className="text mb-20">
                    Automation is basically a set up of automated performance of certain actions within a developed
                    scenario that can streamline a business for simplicity, achieve digital transformation, increase
            ...
            <div className="row">
              <div className="col-12 col-xl-8 m-auto">
                <p className="section__text ta-left ta-md-center">
                  During the past decade we have worked on &#62; 50 projects in industries like SaaS, Ecommerce, Online
                  Gaming etc.
                </p>
              </div>
            </div>
                ...
                <div className="ph-20">
                  ...
                  <div className="count-block w-100 mb-40 mb-md-0">
                    ...
                    <div className="text-large mb-40">
                      ...
                      <p> Any no/low-code automation has a lower cost than hiring a programmer to solve the same problem
                        or hiring a person to do the work
                      </p>
                    </div>
                  </div>
                  <div className="count-block w-100 mb-40 mb-md-0">
                    ...
                    <div className="text-large mb-40">
                      ...
                      <p> Setting up an automated process takes less time than hiring a person.
                        Performing the automated process is always faster than that person doing the job manually
                      </p>
                    </div>
                  </div>
                  <div className="count-block w-100 mb-40 mb-md-0">
        ...
        <OurToolkit itemsFirstColumn={ourToolkitArr} itemsSecondColumns={ourToolkitArr2} imagePosition={'left'}/>
