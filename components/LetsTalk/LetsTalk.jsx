...
function LetsTalk({ contentSide }) {
  ...
  React.useEffect(() => {
    ...
    if (telInputRef.current.value > 1) telInputRef.current.value = '+';
    telInputRef.current.addEventListener('input', setMask);
    telInputRef.current.addEventListener('focus', setMask);
    telInputRef.current.addEventListener('blur', setMask);
  }, []);
